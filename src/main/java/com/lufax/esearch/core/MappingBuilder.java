...
import com.lufax.esearch.annotations.CompletionField;
import com.lufax.esearch.annotations.DateFormat;
import com.lufax.esearch.annotations.Field;
import com.lufax.esearch.annotations.FieldIndex;
import com.lufax.esearch.annotations.FieldType;
import com.lufax.esearch.annotations.GeoPointField;
import com.lufax.esearch.annotations.InnerField;
import com.lufax.esearch.annotations.MultiField;
...
//		}
	...
	private static boolean isGeoPointField(java.lang.reflect.Field field) {
		//field.getType() == GeoPoint.class || field.getAnnotation(GeoPointField.class) != null
		return false;
	}
